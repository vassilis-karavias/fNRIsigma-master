...
parser.add_argument('--loss_type', type=str, default='norminvwishart',
...
parser.add_argument('--sim-folder', type=str, default='springcharge_smalldatasetforgputest',
