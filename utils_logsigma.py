...
# initialises a Tensor of sigma values of size [batchsize, no. of particles, time,no. of axes (isotropic = 1, anisotropic = 4)]
def initsigma(batchsize, time, anisotropic, noofparticles, initvar):
    if anisotropic:
        ani = 4
    else:
        ani = 1
...
def tile(a, dim, n_tile):
    # adapted from https://discuss.pytorch.org/t/how-to-tile-a-tensor/13853
    init_dim = a.size(dim)
    repeat_idx = [1] * a.dim()
